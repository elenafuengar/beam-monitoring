...
def move_dp_over_p(i,j):
	if j == 0:
		DpOverP = myPyJapc.getSimpleValue("SpsLowLevelRF/DpOverPOffset")
		DpOverP["JAPC_FUNCTION"]["X"]=np.array([   0. , 1015. , 1165. , 1215.. , 4065. , 4115., 4186., 6239., 6289. ])
		DpOverP["JAPC_FUNCTION"]["Y"]=np.array([0.,  0.,  0.,  i/1000,  i/1000, 0., 0., 0.,0.])		
		DpOverP = myPyJapc.setSimpleValue("SpsLowLevelRF/DpOverPOffset")
	DpOverP = myPyJapc.getSimpleValue("SpsLowLevelRF/DpOverPOffset")

def activate_chirp():
	

def revert_dp_over_p():
	DpOverP = myPyJapc.getSimpleValue("SpsLowLevelRF/DpOverPOffset")
	DpOverP["JAPC_FUNCTION"]["X"]=np.array([   0. , 1015. , 4186., 6239., 6289. ])
	DpOverP["JAPC_FUNCTION"]["Y"]=np.array([0.,  0.,  0., 0., 0.])
	DpOverP = myPyJapc.setSimpleValue("SpsLowLevelRF/DpOverPOffset")
...
folder = 'QPH0.3_QPV0.05_KLOF0_N10e10'
...
activate_chirp()
for i in range(dp_start, dp_end, dp_step):
	for j in range(dp_rep):
