...
def run(qpv_val, n_slices, n_mp, intensity):
    ...
    qph = 0.2 #knob
    qpv = qpv_val 
    Qp_x = np.array([qph*accQ_x, Octupoles.get_q2(KLOF,KLOD)[0]+612.213*2,-90760.404*6]) #q26 optics
